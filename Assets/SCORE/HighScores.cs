...
{
    const string privateCode = "yqzEGjbHLE-wiILM8KJKbwfQ95k4sgq02hjj58CZfIEQ";  //Key to Upload New Info
    const string publicCode = "63804ddc8f40bb1104522d09";   //Key to download
    ...
    IEnumerator DatabaseDownload()
    {
        ...
        using (UnityWebRequest webRequest = UnityWebRequest.Get(webURL + publicCode + "/pipe/0/10")){
